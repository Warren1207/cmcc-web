...
$.extend( FixedColumns.prototype , {
		...
		var nSWrapper =
			$('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;">'+
				'<div class="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;">'+
					...
					'<div class="DTFC_LeftBodyWrapper" style="position:relative; top:0px; left:0; overflow:hidden;">'+
	...
	"_fnGridLayout": function ()
	{
		...
		if ( this.s.iLeftColumns > 0 )
		{
			...
			if ( oGrid.left.foot ) {
				oGrid.left.foot.style.top = "100px";//(oOverflow.x ? oOverflow.bar : 0)+"px"; // shift footer for scrollbar
			}
