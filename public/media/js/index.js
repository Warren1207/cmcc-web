        ...
        initCalendar: function (y,m,d) {
            ...
            $('#calendar').fullCalendar({ //re-initialize the calendar
                ...
                events: function (start,end, callback) {
                    var url = ['/workcalendar/data?y=',start.getFullYear(),'&m=',start.getMonth(),'&d=',start.getDate()].join('')
                    $.ajax({
                        url: url,
                        dataType: 'json',
                        data: {},
                ...
                dayClick: function(date, allDay, jsEvent, view) {
                   ...
                   $.post("/workcalendar/save",{year:y,month:m,day:d},function(result){
                       ...
                       location.href=["/workcalendar?start=",view.calendar.getDate().getTime()].join('')
                   });
                ...
                viewDisplay: function (view) {//动态把数据查出，按照月份动态查询
                                    ...
                                    // $.post("../../sr/AccessDate.ashx", { start: viewStart, end: viewEnd }, function (data) {
                                         ...
                                         var resultCollection = [{'title':'工作日','id':'123','start':'2017-03-11','end':'2017-03-11','fullname':'名称','allDay':true}];
